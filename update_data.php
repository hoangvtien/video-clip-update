...
// ID goi cap nhat
$nv_update_config['packageID'] = 'NVUDVIDEOCLIP4028';

// Cap nhat cho module nao, de trong neu la cap nhat NukeViet, ten thu muc module neu la cap nhat module
$nv_update_config['formodule'] = 'video-clip';

// Thong tin phien ban, tac gia, ho tro
$nv_update_config['release_date'] = 1462924800;
$nv_update_config['author'] = 'PHAN TAN DUNG (phantandung92@gmail.com)';
$nv_update_config['support_website'] = 'https://github.com/hoaquynhtim99/video-clip-update/tree/4.0.28';
    ...
    try {
        ...
        if (!$num) {
            $db->query("INSERT INTO " . $db_config['prefix'] . "_setup_extensions (
                ...
                79, 'module', 'video-clip', 0, 1, 'video-clip', 'video_clip', '4.0.28 1462924800', " . NV_CURRENTTIME . ", 'PHAN TAN DUNG (phantandung92@gmail.com)', 
